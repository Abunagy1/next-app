...
const BOOKING_STATUS_BG_COL_TW_CLASS = {
  ...
  confirmed: 'bg-green-100 dark:bg-green-900',
  cancelled: 'bg-red-100 dark:bg-red-900',
  failed: 'bg-red-100 dark:bg-red-900',
};

const BOOKING_STATUS_TEXT_COL_TW_CLASS = {
  pending: 'text-yellow-500 dark:text-yellow-200',
  confirmed: 'text-green-700 dark:text-green-200',
  cancelled: 'text-destructive dark:text-red-400',
  failed: 'text-destructive dark:text-red-400',
};

const PAYMENT_STATUS_BG_TW_CLASS = {
  pending: 'bg-yellow-100 dark:bg-yellow-900',
  'pay at property': 'bg-yellow-100 dark:bg-yellow-900',
  paid: 'bg-green-100 dark:bg-green-900',
  failed: 'bg-red-100 dark:bg-red-900',
  cancelled: 'bg-red-100 dark:bg-red-900',
  refunded: 'bg-red-100 dark:bg-red-900',
};

const PAYMENT_STATUS_TEXT_COL_TW_CLASS = {
  pending: 'text-yellow-500 dark:text-yellow-200',
  'pay at property': 'text-yellow-500 dark:text-yellow-200',
  paid: 'text-green-700 dark:text-green-200',
  failed: 'text-red-500 dark:text-red-400',
  cancelled: 'text-destructive dark:text-red-400',
  refunded: 'text-destructive dark:text-red-400',
};
export {
  PASSWORD_REGEX,
  PHONE_REGEX,
