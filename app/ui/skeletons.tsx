          ...
          <table className="hidden min-w-full text-gray-900 dark:text-gray-100 md:table">
            <thead className="rounded-lg text-left text-sm font-normal">
              <tr>
                ...
                <th scope="col" className="px-3 py-5 font-medium">Content Preview</th>
                <th scope="col" className="px-3 py-5 font-medium">Created</th>
            ...
            <tbody className="bg-white dark:bg-gray-800">
              {[...Array(5)].map((_, i) => (
                <tr key={i} className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <td className="px-3 py-3"><div className="h-4 w-32 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
                  <td className="px-3 py-3"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
