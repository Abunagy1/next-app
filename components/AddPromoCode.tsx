...
export function AddPromoCode({ defaultCode = '', getPromoCode }: AddPromoCodeProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="link" className="gap-1">
          <Image alt="plus_icon" width={24} height={24} src="/travel/icons/add.svg" />
          <span>Add Promo Code</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] dark:bg-gray-800 dark:text-white">
        <DialogHeader>
          <DialogTitle className="dark:text-white">Add Promo Code</DialogTitle>
