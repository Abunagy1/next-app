    ...
    <section className="relative z-10 mx-auto mb-[80px] flex w-[90%] gap-[40px] max-sm:flex-col sm:gap-[140px]">
      <div>
        <Logo
          ...
          otherFill={"black"}
        />
        <div className="flex gap-[12px] text-secondary dark:text-gray-400">
          <Link
          ...
          >
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_400_3200"> {/* Keep the capital P */}
                  <rect width="20" height="20" fill="white" transform="translate(0 0.147217)" />
                </clipPath>
              </defs>
            </svg>
          </Link>
      ...
      <div className="grid grow justify-start gap-[24px] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {Object.entries(links).map((link, i) => {
          return (
            ...
            >
              <h3 className="mb-[16px] font-bold text-secondary dark:text-white">{link[0]}</h3>
                  ...
                  return (
                    <div key={item.name}>
                      <Link
                        ...
                        href={item.href}
                        className="text-[0.875rem] hover:underline inline font-medium text-secondary/70 dark:text-gray-300 dark:hover:text-gray-100"
                      >
                        {item.name}
                      </Link>
                    </div>
