...
interface FavouritesFlightAndPlacesTabProps {
  favouriteFlights?: any[];
  favouriteHotels?: any[];
}
...
export function FavouritesFlightAndPlacesTab({
  favouriteFlights = [],
  favouriteHotels = [],
}: FavouritesFlightAndPlacesTabProps) {
  return (
    <Tabs defaultValue="flights" className="w-full">
      <TabsList className="mb-6 flex h-auto flex-col gap-4 bg-transparent sm:flex-row">
